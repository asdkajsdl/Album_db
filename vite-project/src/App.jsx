    ...
    <>
      ...
      <div>
        ...
        <div className="backgroundcolor">
          <div className="gapo">
               <a className="centrar" href="https://open.spotify.com/intl-es/track/6KDSrToeuM3UGiqEB1qNRN#login">
          ...
          <div className="gapo">
               <a className="centrar" href="https://open.spotify.com/intl-es/track/3QaLlAMZDXa2s8eyVoowjw">
          ...
          <div className="gapo">
               <a className="centrar" href="https://open.spotify.com/intl-es/track/072yPZOZLx9HmR3pdEhNwn">
          ...
          <div className="gapo">
               <a className="centrar" href="https://open.spotify.com/intl-es/track/51hLPZbwyJTgz0Ku8ksXfO">
          ...
          <div className="gapo">
               <a className="centrar" href="https://open.spotify.com/intl-es/track/2mMlizGENm5czbZG7YsG5g">
          ...
          <div className="gapo">
               <a className="centrar" href="https://open.spotify.com/intl-es/track/0YlJPYsw6tQbQyy5eNJw5s">
                <li className="Textocolor" >6</li>
                <img src="/public/2.png" alt="" width={40} height={40} />
                <ul className="populares">El Mundo Siempre Estuvo Dividido En Dos</ul>
              </a>
          </div>

          <div className="gapo">
               <a className="centrar" href="https://open.spotify.com/intl-es/track/3EqINdYgqCMeKzRwzQlHiJ">
          ...
          <div className="gapo">
               <a className="centrar" href="https://open.spotify.com/intl-es/track/3LUmfbAsFNUcuLyd6uSbun">
          ...
          <div className="gapo">
               <a className="centrar" href="https://open.spotify.com/intl-es/track/6dzsBX9dJzIOaURSAgfYxH">
          ...
          <div className="gapo">
               <a className="centrar" href="https://open.spotify.com/intl-es/track/5KRXGRFDEBA7ukH5MUTQH1">
                <li className="Textocolor" >10</li>
                <img src="/public/NicolasCage.jpg" alt="" width={40} height={40} />
